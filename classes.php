...
function admin_encashment_list_request(){
	...
	if ($sel_enc_lst->rowCount()>0) {
		...
		echo "</thead><tbody>";
		$cntt=1;
$enc_net_income_ttl=$enc_tax_ttl=$enc_sys_fs_ttl=$enc_before_ttl=$enc_remain_ttl=$enc_earned_ttl=0;
		...
		echo "<th>".$enc_net_income_ttl."</th>";
		echo "<th>".$enc_tax_ttl."</th>";
		echo "<th>".$enc_sys_fs_ttl."</th>";
		echo "<th>".$enc_earned_ttl."</th>";
		echo "<th>".$enc_before_ttl."</th>";
		echo "<th>".$enc_remain_ttl."</th>";
		echo "<th>-</th>";
		echo "<th>-</th>";
...
$enc_net_income_ttl=$enc_tax_ttl=$enc_sys_fs_ttl=$enc_before_ttl=$enc_remain_ttl=$enc_earned_ttl=0;
		...
		echo "<center><h3>No Encashment Available for the chosen payment method</h3></center>";
	}
}
